...
public class StudentRestController {
    ...
    public ResponseEntity<Void> updateStudent(@RequestBody Student student, @PathVariable("studentId") Integer studentId) {
        validator.validate(student);
    ...
    public Page<Student> getStudenti(@ParameterObject Pageable pageable) {
        return studentService.getStudenti(pageable);
    }
